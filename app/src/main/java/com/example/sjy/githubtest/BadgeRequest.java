 ...
 **/
public class BadgeRequest extends StringRequest {   //stringrequest : 문자열을 결과로 받는 요청 정보, 서버로부터 문자열 데이터를 얻을 목적으로 사용하는 클래스

    //서버 url 설정(php파일 연동)
    final static  private String URL="http://polarbear1022.dothome.co.kr/badge.php";
    private Map<String,String> map;

    public BadgeRequest(String uid, Response.Listener<String> listener){
